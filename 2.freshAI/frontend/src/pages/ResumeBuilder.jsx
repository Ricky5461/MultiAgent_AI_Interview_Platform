        ...
        <div className="mx-auto flex h-12 max-w-7xl items-center justify-between px-3 sm:px-5">
          ...
          <button onClick={()=>setShowPreview(true)}
            className="flex h-8 items-center justify-center rounded-lg
                border border-black/15 text-black/60 transition px-2 
        ...
        <div className="mx-auto w-full max-w-2xl">
          <div className="mb-4">
            ...
            <div className="w-full h-1 bg-black/8 rounded-full overflow-hidden">
              <div
                className="h-full bg-[#0a0a0a] rounded-full overflow-all 
             duration-300"
          ...
          <div className="flex items-center justify-between">
            ...
            py-2 rounded-lg text-xs font-semibold bg-[#000000]/90 backdrop-blur-2xl
            border border-white/10 text-white shadow-[0_8px_24px_rgba(0,0,0,0.25)]
            hover:border-white/20 transition-all"
              ...
              rounded-lg text-xs font-semibold bg-[#000000]/90 backdrop-blur-2xl border
