...
function ATSTemplate({data}) {
    ...
    return (
    <div className='box-border w-[210mm] min-h-[297mm] bg-white px-[18mm]
                    py-[15mm] text-black' style={{fontFamily:"Times New Roman, Times, serif",}}>
        ...
        <div className='mb-2.5 border-b-2 border-black pb-2.5 text-center'>
            ...
            <div className='flex flex-wrap justify-center text-[10.25px]text-black'>
              {[
                email,
                phone,
                location,
        ...
        {summary && <section className='mb-3.25 '>
           <h2 className='mt-0 mb-2.25 border-b-[1.5px] border-black
           pb-0.75 text-[10.5px] font-bold uppercase tracking-[0.14em]'>
        ...
        <section className='mb-3.25 '>
           ...
           {experience.map((exp,i)=>(
            <div key={i} className='mb-2.75 break-inside-avoid print:break-inside-avoid'>
        ...
        <section className='mb-3.25 '>
           ...
           {projects.map((proj,i)=>(
            <div key={i} className='mb-2.75 break-inside-avoid print:break-inside-avoid'>
               ...
               {proj.techStack && <div className='mb-0.5 text-[11px] italic text-black'>
