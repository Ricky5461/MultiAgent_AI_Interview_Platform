...
function PreviewResume({data,onBack,user, setUser}) {
    ...
    <div className='min-h-screen  bg-white text-[#0a0a0a]'>
        {/* header */}
        <div className='sticky top-0 z-20 border-b border-black/8 bg-white/80
        backdrop-blur-xl'>
          <div className='mx-auto flex max-w-7xl flex-col gap-3 px-3 py-3 sm:flex-row
          sm:items-center sm:justify-between sm:px-5'>
            ...
            <div className='flex items-center justify-between lg:justify-end gap-2.5'>
               <button onClick={onBack} className='flex h-8 items-center justify-center gap-1.5 rounded-lg
                border border-black/15 px-2.5 sm:px-3 text-xs text-black/60
                transition hover:border-black/35 hover:text-[#0a0a0a]'>
                <FiArrowLeft size={15}/>
        ...
        <div className='overflow-auto bg-[#F8F9FA] px-3 py-4 sm:px-6 sm:py-8'>
            <div className='mx-auto flex justify-center'>
                <div style={{
                    ...
                    <div ref={resumeRef} className='rounded-md bg-white shadow-2xl
                    [0_0_50px_rgba(0,0,0,0.6)]'>
